...
namespace Humm\HummPaymentGateway\Block\System\Config\Adminhtml\Fieldset;

/**
 * roger.bi@flexigroup.com.au
 * Fieldset renderer for Humm payment Solution
 */
class Payment extends \Magento\Config\Block\System\Config\Form\Fieldset
{
    ...
    protected function _getHeaderTitleHtml($element)
    {
        ...
        $html .= '<div class="button-container"><button type="button"' .
            ...
            (empty($groupConfig['humm_ec_separate']) ? '' : 'humm-ec-separate') .
            $disabledClassString .
            '" id="' .
            $htmlId .
            '-head" onclick="hummToggleSolution.call(this, \'' .
            $htmlId .
            "', '" .
            $this->getUrl(
                'adminhtml/*/state'
    ...
    protected function _getExtraJs($element)
    {
        $script = "require(['jquery', 'prototype'], function(jQuery){
            window.hummToggleSolution = function (id, url) {
                var doScroll = false;
